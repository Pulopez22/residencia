...
<div class="container pb-6 pt-6">
    ...
    <div class="columns pb-6 pt-6">
        ...
        <div class="column">
            <div class="full-width sale-details text-condensedLight">
                <div class="has-text-weight-bold">Comprado por:</div>
        ...
        <div class="column">
            <div class="table-container">
                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                    ...
                    <tbody>
                        <?php
                            $detalle_venta = $insLogin->seleccionarDatos(
                                "Normal",
                                "venta_detalle WHERE venta_codigo = '" . $datos_venta['venta_codigo'] . "'",
                                "*",
                                0
                            );
                        ...
                        <tr class="has-text-centered" >
                            ...
                            <td><?php echo MONEDA_SIMBOLO . number_format($detalle['venta_detalle_precio_compra'], MONEDA_DECIMALES, MONEDA_SEPARADOR_DECIMAL, MONEDA_SEPARADOR_MILLAR) . " " . MONEDA_NOMBRE; ?></td>
    ...
    <div class="columns pb-6 pt-6">
        <p class="has-text-centered full-width">
            ...
            <i class="fas fa-file-invoice-dollar fa-fw"></i> &nbsp; Imprimir PDF
            </button> &nbsp;&nbsp; 
